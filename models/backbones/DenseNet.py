...
class DenseNet(nn.Module):
    ...
    This is only the backbone without last FC layer.
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # self.features = nn.Sequential(nn.Conv2d(3, num_init_features, kernel_size=3, stride=1, padding=1, bias=True)
                                    #   )
        # Each denseblock
...
def dense_small():
    net = DenseNet(16, (4,4,4), 32, 1, 0, True)
    return net
