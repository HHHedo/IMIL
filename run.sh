...
# python main.py --config DigestSemi --log_dir ./experiments/NorAug_semi/2020_07_26/f4/ --data_root /home/ltc/Documents/ltc/DATA/HISMIL/4 --workers 8  --semi_ratio 0.5
 ...
 CUDA_VISIBLE_DEVICES=5 python main.py --task DigestSeg --config DigestSegTOPK --log_dir ./experiments/MoCoAug_TOPK/2021_08_12_noCenter/f0/ --data_root /remote-home/share/DATA/HISMIL/5_folder/0 --database --workers 8 --mmt 0

 CUDA_VISIBLE_DEVICES=5 python main.py --task DigestSeg --config DigestSegTOPK --log_dir ./experiments/MoCoAug_TOPK/2021_08_12_noCenter/f1/ --data_root /remote-home/share/DATA/HISMIL/5_folder/1 --database --workers 8 --mmt 0

 CUDA_VISIBLE_DEVICES=5 python main.py --task DigestSeg --config DigestSegTOPK --log_dir ./experiments/MoCoAug_TOPK/2021_08_12_noCenter/f2/ --data_root /remote-home/share/DATA/HISMIL/5_folder/2 --database --workers 8 --mmt 0

 CUDA_VISIBLE_DEVICES=5 python main.py --task DigestSeg --config DigestSegTOPK --log_dir ./experiments/MoCoAug_TOPK/2021_08_12_noCenter/f3/ --data_root /remote-home/share/DATA/HISMIL/5_folder/3 --database --workers 8 --mmt 0

 CUDA_VISIBLE_DEVICES=5 python main.py --task DigestSeg --config DigestSegTOPK --log_dir ./experiments/MoCoAug_TOPK/2021_08_12_noCenter/f4/ --data_root /remote-home/share/DATA/HISMIL/5_folder/4 --database --workers 8 --mmt 0
