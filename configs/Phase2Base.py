...
class Config(object):
    ...
    log_dir = "/remote-home/gyf/project/HisMIL/experiments/HISPhase2/test/"
    resume = -1
    ## dataset configs
    data_root = "/remote-home/gyf/DATA/HISMIL/10x_0.75/ratio_0.5/"
    ...
    def build_all(self):
        ...
        self.net, self.optimizer, self.lrsch, self.criterion = self.logger.load(self.net, 
                                                                                ...
                                                                                self.criterion, 
                                                                                self.resume)
        self.train_mmbank = TensorMemoryBank(self.trainset.bag_num, 
        ...
        ##build tester
        self.test_mmbank = TensorMemoryBank(self.testset.bag_num, 
