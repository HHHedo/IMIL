...
class Config(object):
    ...
    def build_model(self):
        ...
        print(np.array(self.trainset.instance_in_which_bag).max())
        self.clsnet_base = BaseClsNet(self.backbone, np.array(self.trainset.instance_in_which_bag).max()+1).to(self.device)
